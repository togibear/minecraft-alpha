...
class Chunk:
    def __init__(self, world, chunk_position):
        ...
        gl.glGenBuffers(1, self.shading_vbo)
    ...
    def update_mesh(self):
        ...
        def add_face(face):
            ...
            self.mesh_shading.extend(block_type.shading[face])
        ...
        gl.glBufferData(
            gl.GL_ARRAY_BUFFER,
            ctypes.sizeof(gl.GLfloat * len(self.mesh_shading)),
            (gl.GLfloat * len(self.mesh_shading)) (*self.mesh_shading),
            gl.GL_STATIC_DRAW)
